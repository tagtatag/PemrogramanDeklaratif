...
% Pss is a list of lists representing the game board. #pss adalah daftar yang mewakili papan permainan

sudoku(Pss) :- 
    flatten(Pss, Ps),
    Ps in 1..9, #inisialisasi angka 1 sampai 9
    maplist(all_different, Pss), #semua elemen harus berbeda nilainya
